 ...
 */
@Component("hi02")
public class HelloInterceptor02 implements HandlerInterceptor {
	//只初始化一次，在第一次请求的时候初始化
	public HelloInterceptor02() {
		System.out.println("%%%%%%%%%HelloInterceptor02初始化操作%%%%%%%%%%");
	}
	@Override//到达handler处理前调用处理的方法
	public boolean preHandle(HttpServletRequest request,
	  HttpServletResponse response, Object handler) throws Exception {
		System.out.println("%%%%%%%%%HelloInterceptor02.preHandle()%%%%%%%%%%");
	...
	public void postHandle(HttpServletRequest request,
		...
		System.out.println("%%%%%%%%%HelloInterceptor02.postHandle()%%%%%%%%%%");
	...
	public void afterCompletion(HttpServletRequest request,
			...
			throws Exception {
		System.out.println("%%%%%%%%%HelloInterceptor02.afterCompletion()%%%%%%%%%%");
