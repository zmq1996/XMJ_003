...
<body class="easyui-layout" id="myBody">   
    ...
    <div data-options="region:'west',title:'菜单栏',collapsible:false" style="width:240px;">
    	<div id="leftSide" style="width:300px;height:200px;color:#666;font-size:20px;">   
